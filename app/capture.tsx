...
export default function App() {
    ...
    const [imageStats, setImageStats] = useState<CameraCapturedPicture | null>(
        null
    );
    const [image, setImage] = useState<string | null>(null);
    const [poiRequest, setPoiRequest] = useState<FoodRecognitionRequest | null>(
        null
    );
    ...
    return (
        <View style={{ flex: 1, justifyContent: "center" }}>
            ...
            {pois?.result.map((poi, index) => {
                ...
                if (poi.rel_id == 0 && poi.relabel == 1 && poi.label != "Pizza")
                    return null;
